...
if(NOT BEMAN_EXEMPLAR_LOCKFILE)
  set(BEMAN_EXEMPLAR_LOCKFILE "lockfile.json" CACHE FILEPATH "Path to the dependency lockfile for the Beman Exemplar.")
endif()
...
file(
  REAL_PATH "${BEMAN_EXEMPLAR_LOCKFILE}" BemanExemplar_lockfile BASE_DIRECTORY "${BemanExemplar_projectDir}"
  EXPAND_TILDE
)
...
set_property(
  DIRECTORY "${BemanExemplar_projectDir}" APPEND PROPERTY CMAKE_CONFIGURE_DEPENDS "${BemanExemplar_lockfile}"
)
...
function(BemanExemplar_provideDependency method package_name)
  ...
  string(JSON BemanExemplar_numDependencies ERROR_VARIABLE BemanExemplar_error
  ...
  foreach(BemanExemplar_index RANGE "${BemanExemplar_maxIndex}")
    set(BemanExemplar_errorPrefix "${BemanExemplar_lockfile}, dependency ${BemanExemplar_index}")
    ...
    if(BemanExemplar_error)
      message(FATAL_ERROR "${BemanExemplar_errorPrefix}: ${BemanExemplar_error}")
    endif()
    ...
    if(method STREQUAL "FIND_PACKAGE")
      if(package_name STREQUAL BemanExemplar_pkgName)
        string(APPEND BemanExemplar_debug "Redirecting find_package calls for ${BemanExemplar_pkgName} "
        ...
        FetchContent_Declare(
          "${BemanExemplar_name}" GIT_REPOSITORY "${BemanExemplar_repo}" GIT_TAG "${BemanExemplar_tag}"
          EXCLUDE_FROM_ALL
        )
